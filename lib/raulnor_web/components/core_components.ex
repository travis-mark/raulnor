defmodule RaulnorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RaulnorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RaulnorWeb.Gettext, "errors", msg, opts)
    end
  end
